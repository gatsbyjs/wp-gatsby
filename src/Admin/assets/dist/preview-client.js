(function () {
	...
	a.style.display="none";},100);},50);}var requestPreviewFrontendIsOnline=/*#__PURE__*/function(){var a=asyncToGenerator(/*#__PURE__*/regenerator.mark(function a(){var b,c,d;return regenerator.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:return a.next=2,fetch("/?".concat(initialState.graphqlEndpoint),{method:"POST",body:JSON.stringify({query:previewFrontendIsOnlineQuery,variables:{postId:initialState.postId}}),headers:{"Content-Type":"application/json"}});case 2:return a.next=4,a.sent.json();case 4:if(a.t1=b=a.sent,a.t0=null===a.t1,a.t0){a.next=8;break}a.t0=void 0===b;case 8:if(!a.t0){a.next=12;break}a.t2=void 0,a.next=13;break;case 12:a.t2=null===(c=b.data)||void 0===c||null===(d=c.wpGatsby)||void 0===d?void 0:d.isPreviewFrontendOnline;case 13:return a.abrupt("return",a.t2);case 14:case"end":return a.stop();}},a)}));return function(){return a.apply(this,arguments)}}(),frontendOnlineCheckCount=0;/**
